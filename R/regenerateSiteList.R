...
intervalList<- paste(chromosomeIndex, ":",dataFull[,1], sep="")

 
outfile<- paste(latexDir , "/interval/", subName, ".intervals", sep="")
write.table(intervalList, file=outfile, row.names=F, col.names=F, quote=F)
