#!/usr/local/bin/bash
# This is the core script, should be called from another script (runCEU1X_ChromY.sh) and variables are passed to this script.
...
# variable_site_file=ALL.chr${chromosome}.integrated_phase1_v3.20101123.snps_indels_svs.genotypes.vcf.gz"
